...
class Beck_signup_actions
{
    ...
    public static function create($id = '')
    {
        ...
        $op = empty($id) ? "beck_signup_store" : "beck_signup_update";
    ...
    public static function store()
    {
        ...
        $sql = "insert into `" . $xoopsDB->prefix("beck_signup") . "` (
        `欄位1`,
        `欄位2`,
        `欄位3`
        ) values(
    ...
    public static function update($id = '')
    {
        ...
        $sql = "update `" . $xoopsDB->prefix("beck_signup") . "` set
        `欄位1` = '{$欄位1值}',
        `欄位2` = '{$欄位2值}',
        `欄位3` = '{$欄位3值}'
        where `id` = '$id'";
    ...
    public static function destroy($id = '')
    {
        ...
        $sql = "delete from `" . $xoopsDB->prefix("beck_signup") . "`
        where `id` = '{$id}'";
        $xoopsDB->queryF($sql) or Utility::web_error($sql, __FILE__, __LINE__);
    }
    ...
    public static function get($id = '')
    {
        ...
        $sql = "select * from `" . $xoopsDB->prefix("beck_signup") . "`
        where `id` = '{$id}'";
